...
content_validation:
  ...
  reviewer: agent
  core_claims:
    - claim: Microsoft Learn maintains Azure Virtual Machines troubleshooting guidance that includes boot failure scenarios.
      source: https://learn.microsoft.com/en-us/troubleshoot/azure/virtual-machines/welcome-virtual-machines
      verified: true
    - claim: Boot diagnostics captures serial log output and screenshots during Azure VM boot troubleshooting.
