...
content_sources:
  diagrams:
    - id: troubleshooting-playbooks-rdp-ssh-connection-failures-symptoms
      type: flowchart
...
content_validation:
  ...
  reviewer: agent
  core_claims:
    - claim: Boot diagnostics can help distinguish guest boot problems from pure connectivity problems.
      source: https://learn.microsoft.com/en-us/azure/virtual-machines/boot-diagnostics
      verified: true
    - claim: Azure Bastion provides portal-based RDP and SSH connectivity to virtual machines.
...
<!-- diagram-id: troubleshooting-playbooks-rdp-ssh-connection-failures-symptoms -->
```mermaid
flowchart TD
