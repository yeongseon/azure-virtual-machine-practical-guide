...
### Step 3: Confirm availability placement and failover assumptions

This lab validates whether the VM placement model matches the availability target. Confirm the zone assignment and record what would change if the workload needed VMSS or load-balanced multi-instance capacity.
